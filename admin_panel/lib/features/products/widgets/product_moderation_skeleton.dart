...
/// Skeleton for the admin product moderation list loading state.
/// Must be wrapped in [SkeletonContainer].
class ProductModerationSkeleton extends StatelessWidget {
  const ProductModerationSkeleton({super.key});
            ...
            child: Column(
              children: [
                Padding(
                  ...
                  child: Row(
                    children: const [
                      Expanded(flex: 4, child: SkeletonBox(width: 60, height: 12)),
                ...
                ...List.generate(6, (_) => const _ProductRowSkeleton()),
              ],
            ),
          ),
        ],
    ...
    return Column(
      children: [
        Padding(
          ...
          child: Row(
            children: const [
              Expanded(flex: 4, child: SkeletonBox(width: double.infinity, height: 14)),
              SizedBox(width: AppSpacing.base),
              Expanded(
                flex: 3,
                child: Column(
