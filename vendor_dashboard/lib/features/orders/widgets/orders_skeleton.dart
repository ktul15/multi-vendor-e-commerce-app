...
/// Skeleton for the orders table loading state.
    ...
    return Column(
      ...
      children: [
        ...
        ListView.separated(
          ...
          itemBuilder: (context, index) => const _OrderRowSkeleton(),
        ),
      ],
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        children: const [
          ...
          SizedBox(width: AppSpacing.md),
          Expanded(flex: 1, child: SkeletonBox(width: 32, height: 32, radius: 8)),
        ],
      ),
    );
  }
